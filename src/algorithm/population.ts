...
class Population {
    ...
    generate() {
        ...
        console.log("this is sum and prob", sum, this.population);
    ...
    acceptReject() {
        let index = 0;
        let r = Math.random();
        console.log("this is random", r, this.population, index);
        
        while(r>0){      
            console.log("inside r", r, this.population[index].prob);
                  
            if(r - this.population[index].prob < 0){
                break;
            }else{
                index++
            }
